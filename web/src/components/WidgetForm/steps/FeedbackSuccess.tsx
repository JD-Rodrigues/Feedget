...
export function FeedbackSuccess({back}:FeedbackSuccessProps) {
    return (
        <>
            <header>
                <CloseButton/>
            ...
            <div className="flex flex-col items-center py-6 w-[304px]">
                ...
                <span className="text-xl mt-2">Sucesso!</span>

                <button className="py-2 px-6 mt-6 bg-darkSurfaceSecondary-500 text-sm leading-6 hover:bg-[#2f2f33] transition-colors border-2 border-transparent focus:border-brand-500 hover:border-brand-500 outline-none"
                onClick={back}>
                    Quero enviar outro!
                </button>                
            </div>
